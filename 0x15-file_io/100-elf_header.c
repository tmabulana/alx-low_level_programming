...
/**
 * check_elf - This will check if a file is an ELF file.
 * @e_ident: The pointer to an array containing the ELF magic numbers.
 * Description: Should the file not be an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
int index;
...
/**
 * print_magic - This will print the magic numbers of an ELF header.
 * @e_ident: This is the pointer to an array containing the ELF magic numbers.
 * Description: These are the magic numbers are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
int index;
...
/**
 * print_abi - This will prints the ABI version of an ELF header.
...
/**
 * print_type - It will print the type of an ELF header.
 * @e_type: This the ELF type.
 * @e_ident: The pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
...
/**
 * print_entry - It will print the entry point of an ELF header.
 * @e_entry: This the address of the ELF entry point.
 * @e_ident: The pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
...
/**
 * close_elf - It will close an ELF file.
 * @elf: This is the file descriptor of the ELF file.
 * Description: If the file cannot be closed entirely - exit code 98.
 */
void close_elf(int elf)
{
if (close(elf) == -1)
