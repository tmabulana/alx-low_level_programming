...
/**
 * create_buffer - This buffer will allocate 1024 bytes for a buffer.
...
/**
 * main - This are the copies of the contents of a file to another file.
 * @argc: This the number of arguments supplied to the program.
 * @argv: The array of pointers to the arguments.
 * Return: 0 on success.
 * Description: When the argument count is incorrect - exit code 97.
 * If file_from does not exist or cannot be read entirely - exit code 98.
 * If file_to cannot be created or written it can - exit code 99.
